...
import com.example.assignmenttopsadvance.databinding.FragmentFrameBinding;
...
public class FrameFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.imageViewFrameAnimation.setBackgroundResource(R.drawable.frame);
        AnimationDrawable drawable= (AnimationDrawable) binding.imageViewFrameAnimation.getBackground();
        drawable.start();
        binding.btnNext.setOnClickListener(v -> {
            Navigation.findNavController(getView())
                    .navigate(R.id.action_frameFragment_to_lottieFragment);
        });
